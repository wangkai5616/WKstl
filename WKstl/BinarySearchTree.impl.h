...
namespace WKstl {
	...
	template<class T>
	void binary_search_tree<T>::print_levelorder(const std::string& delim, std::ostream& os)const {
		auto temp = root_;
		if (temp != 0) {
			std::deque<node *> q;
			q.push_back(temp);
	...
	template<class T>
	void binary_search_tree<T>::print_preorder_aux(const std::string& delim, std::ostream& os, const node *ptr)const {
		if (ptr) {
			os << ptr->data_ << delim;
	...
	template<class T>
	void binary_search_tree<T>::print_preorder(const std::string& delim, std::ostream& os)const {
	...
	template<class T>
	void binary_search_tree<T>::print_postorder_aux(const std::string& delim, std::ostream& os, const node *ptr)const {
		if (ptr) {
	...
	template<class T>
	void binary_search_tree<T>::print_postorder(const std::string& delim, std::ostream& os)const {
