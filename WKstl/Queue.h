...
#include "Vector.h"
namespace WKstl {
	template<class T,class Container=WKstl::deque<T>>
	class queue {
	public:
	...
	template<class T,class Container=WKstl::vector<T>,
		class Compare=WKstl::less<typename Container::value_type>>
	...
	public:
		...
		priority_queue(InputIterator first, InputIterator last,
			...
			WKstl::make_heap(container_.begin(), container_.end());
		}
		bool empty() const {
		...
		void push(const value_type& val) {
			...
			WKstl::push_heap(container_.begin(), container_.end(), compare_);
		}
		void pop() {
			WK::pop_heap(container_.begin(), container_.end(), compare_);
			container_.pop_back();
		}
		void swap(priority_queue& x) {
			WKstl::swap(container_, x.container_);
			WKstl::swap(compare_, x.compare_);
		}
	public:
